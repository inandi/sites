 ...
 * 
 * @param {string} pageTitle - The title of the page (e.g., "Alcovict - Android App")
...
class LoadJs {
    ...
    constructor(pageTitle, pageName, thisPageCreationYear, isLatest, selfVersion, fileName) {
        ...
        this.hostURL = "https://inandi.github.io/sites/alcovict/";
     ...
     * Example: "Alcovict - Android App © 2025"
     * 
     * @private
     * @returns {void}
     */
