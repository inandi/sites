 ...
 * @version 1.0
 * @since 1.0 (__STRING_PAGE_CREATION_YEAR__)
 */
 ...
 * 
 * @param {string} pageTitle - The title of the page (e.g., "__STRING_PAGE_TITLE__")
...
class LoadJs {
    ...
    constructor(pageTitle, pageName, thisPageCreationYear, isLatest, selfVersion, fileName) {
        ...
        // @todo replace with the actual host URL
        this.hostURL = "https://inandi.github.io/sites/__PAGE_DIRECTORY__/";
     ...
     * Example: "__STRING_PAGE_TITLE__ © __STRING_PAGE_CREATION_YEAR__"
     * 
     * @private
     * @returns {void}
     */
