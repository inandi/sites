 ...
 * 
 * @param {string} pageTitle - The title of the page (e.g., "InQuizIt - Android App")
...
class LoadJs {
    ...
    constructor(pageTitle, pageName, thisPageCreationYear, isLatest, selfVersion, fileName) {
        ...
        this.hostURL = "https://inandi.github.io/sites/inquizit/";
     ...
     * Example: "InQuizIt - Android App © 2025"
     * 
     * @private
     * @returns {void}
     */
